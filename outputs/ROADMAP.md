...
- Persisted records and audit history (browser-local today, with reviewed JSON workspace backup/restore, a filterable audit trail, and a first read-only API boundary).
