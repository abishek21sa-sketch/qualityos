...
The current app stores actions, acknowledgements, evidence requests, CAPA records, lot disposition, root-cause notes, and audit events in browser `localStorage`. That state is device/browser-local and is not shared between users or deployments.
